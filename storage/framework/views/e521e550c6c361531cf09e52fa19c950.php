            ...
            <div class="row learts-mb-n50">
                ...
                <div class="col-xl-9 col-lg-8 col-12 learts-mb-50">
                    <div class="single-blog">
                        <div class="image">
                            <a href="blog-details-right-sidebar.html"><img src="<?php echo e(asset('assets/images/blog/s870/blog-1.webp')); ?>"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="content">
                            <ul class="category">
                    ...
                    <div class="blog-author">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/comment/comment-1.webp')); ?>" alt="">
                            <div class="social">
                    ...
                    <div class="Comments-wrapper">
                        ...
                        <ul class="comment-list">
                            <li>
                                <div class="comment">
                                    <div class="thumbnail">
                                        <img src="<?php echo e(asset('assets/images/comment/comment-2.webp')); ?>" alt="">
                                    </div>
                                    <div class="content">
                                ...
                                <ul class="child-comment">
                                    <li>
                                        <div class="comment">
                                            <div class="thumbnail">
                                                <img src="<?php echo e(asset('assets/images/comment/comment-3.webp')); ?>" alt="">
                                            </div>
                                            <div class="content">
                            ...
                            <li>
                                <div class="comment">
                                    <div class="thumbnail">
                                        <img src="<?php echo e(asset('assets/images/comment/comment-4.webp')); ?>" alt="">
                                    </div>
                                    <div class="content">
                ...
                <div class="col-xl-3 col-lg-4 col-12 learts-mb-10">
                    ...
                    <div class="single-widget learts-mb-40">
                        ...
                        <ul class="widget-blogs">
                            <li class="widget-blog">
                                <div class="thumbnail">
                                    <a href="blog-details-right-sidebar.html"><img
                                            src="<?php echo e(asset('assets/images/blog/widget/widget-1.webp')); ?>" alt="Widget Blog Post"></a>
                                </div>
                                <div class="content">
                            ...
                            <li class="widget-blog">
                                <div class="thumbnail">
                                    <a href="blog-details-right-sidebar.html"><img
                                            src="<?php echo e(asset('assets/images/blog/widget/widget-2.webp')); ?>" alt="Widget Blog Post"></a>
                                </div>
                                <div class="content">
                            ...
                            <li class="widget-blog">
                                <div class="thumbnail">
                                    <a href="blog-details-right-sidebar.html"><img
                                            src="<?php echo e(asset('assets/images/blog/widget/widget-3.webp')); ?>" alt="Widget Blog Post"></a>
                                </div>
                                <div class="content">
                    ...
                    <div class="single-widget learts-mb-40">
                        <div class="widget-banner">
                            <img src="<?php echo e(asset('assets/images/banner/widget-banner.webp')); ?>" alt="">
                        </div>
                    </div>
                    <!-- Categories End -->
...
<?php echo $__env->make('home.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\Amit Kumar\Laravel\handmadeinindia\resources\views/home/single-blog.blade.php ENDPATH**/ ?>