        ...
        <div class="container">
            <div class="row learts-mb-n40">
                ...
                <div class="col-lg-4 col-md-6 col-12 learts-mb-40">
                    <div class="blog">
                        <div class="image">
                            <a href="blog-details-right-sidebar.html"><img src="<?php echo e(asset('assets/images/blog/s370/blog-1.webp')); ?>"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="content">
                            <ul class="meta">
                            ...
                            <a href="<?php echo e(route('single.blog', ['slug'=> 'test-blog'])); ?>" class="link">Read More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12 learts-mb-40">
                    <div class="blog">
                        <div class="image">
                            <a href="blog-details-right-sidebar.html"><img src="<?php echo e(asset('assets/images/blog/s370/blog-2.webp')); ?>"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="content">
                            <ul class="meta">
                ...
                <div class="col-lg-4 col-md-6 col-12 learts-mb-40">
                    <div class="blog">
                        <div class="image">
                            <a href="blog-details-right-sidebar.html"><img src="<?php echo e(asset('assets/images/blog/s370/blog-3.webp')); ?>"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="content">
                            <ul class="meta">
                ...
                <div class="col-lg-4 col-md-6 col-12 learts-mb-40">
                    <div class="blog">
                        <div class="image">
                            <a href="blog-details-right-sidebar.html"><img src="<?php echo e(asset('assets/images/blog/s370/blog-4.webp')); ?>"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="content">
                            <ul class="meta">
                ...
                <div class="col-lg-4 col-md-6 col-12 learts-mb-40">
                    <div class="blog">
                        <div class="image">
                            <a href="blog-details-right-sidebar.html"><img src="<?php echo e(asset('assets/images/blog/s370/blog-5.webp')); ?>"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="content">
                            <ul class="meta">
                ...
                <div class="col-lg-4 col-md-6 col-12 learts-mb-40">
                    <div class="blog">
                        <div class="image">
                            <a href="blog-details-right-sidebar.html"><img src="<?php echo e(asset('assets/images/blog/s370/blog-6.webp')); ?>"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="content">
                            <ul class="meta">
...
<?php echo $__env->make('home.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\Amit Kumar\Laravel\handmadeinindia\resources\views/home/blog.blade.php ENDPATH**/ ?>