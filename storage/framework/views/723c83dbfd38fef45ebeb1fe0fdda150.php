            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <div class="header-logo">
                        <a href="index.html"><img src="<?php echo e(asset('assets/images/logo/logo-2.webp')); ?>" alt="Learts Logo"></a>
                    </div>
                </div>
                <!-- Header Logo End -->
                ...
                <div class="col-auto me-auto">
                    <nav class="site-main-menu site-main-menu-left menu-height-100 justify-content-center">
                        <ul>
                            <li><a href="<?php echo e(route('home')); ?>"><span class="menu-text">Home</span></a></li>
                            <li><a href="<?php echo e(route('shop')); ?>"><span class="menu-text">Shop</span></a></li>
                            <li><a href="<?php echo e(route('blog')); ?>"><span class="menu-text">Blog</span></a></li>
                            <li class="has-children"><a href="#"><span class="menu-text">Pages</span></a>
                                <ul class="sub-menu">
                                    <li><a href="<?php echo e(route('about-us')); ?>"><span class="menu-text">About us</span></a></li>
                                    <li><a href="<?php echo e(route('contact-us')); ?>"><span class="menu-text">Contact us</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
...
<?php /**PATH C:\Users\lenovo\Desktop\Amit Kumar\Laravel\handmadeinindia\resources\views/home/layouts/header.blade.php ENDPATH**/ ?>